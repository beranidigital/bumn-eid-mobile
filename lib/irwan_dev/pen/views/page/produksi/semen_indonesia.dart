...
import 'package:bumn_eid/irwan_dev/pen/controllers/produksi/semen_indonesia_controller.dart';
...
class SemenIndonesia extends StatelessWidget {
  String id;
  SemenIndonesia({
    Key key,
    this.id,
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: GetBuilder<SemenIndonesiaController>(
                    init: SemenIndonesiaController(),
                    builder: (controller) {
                      return Column(
                        children: [
                          Text(
                            "Summary Semen Indonesia",
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  "Top 10 Kinerja Penjualan Berdasarkan Provinsi",
