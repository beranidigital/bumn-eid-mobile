...
import 'package:bumn_eid/irwan_dev/pen/controllers/tranportasi/garuda_controller.dart';
...
class GarudaIndonesia extends StatelessWidget {
  String id;
  GarudaIndonesia({
    Key key,
    this.id,
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: GetBuilder<GarudaController>(
                    init: GarudaController(),
                    builder: (controller) {
                      return Column(
                        children: [
                          Text(
                          ...
                          Row(
                            children: [
                              text_underline_button(() {
                                controller.setKondisiLayanan(0);
                              }, "Penerbangan",
                                  (controller.kondisiLayanan == 0) ? 1 : 0),
                              text_underline_button(() {
                                controller.setKondisiLayanan(1);
                              }, "Kargo",
                                  (controller.kondisiLayanan == 1) ? 1 : 0),
                            ],
                          ),
                          SizedBox(height: 15),
                          Row(
                          ...
                          Container(
                            padding: EdgeInsets.only(
                                bottom: 35, top: 10, left: 10, right: 15),
                            decoration: decor,
                            child: Column(
                              children: [
                                Text(
