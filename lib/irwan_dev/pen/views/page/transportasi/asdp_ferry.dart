...
import 'package:bumn_eid/irwan_dev/pen/controllers/tranportasi/asdp_ferry_controller.dart';
...
class AsdpFerry extends StatelessWidget {
  String id;
  AsdpFerry({
    Key key,
    this.id,
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: GetBuilder<AsdpFerryController>(
                    init: AsdpFerryController(),
                    builder: (controller) {
                      return Column(
                        children: [
                          Text(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  "Top 10 Pelabuhan Berdasarkan Jumlah Perjalanan",
