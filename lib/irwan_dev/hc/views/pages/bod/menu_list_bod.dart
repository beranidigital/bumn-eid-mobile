...
class MenuListBod extends StatelessWidget {
  String pathEndPoint;
    ...
    return Column(
      ...
      children: [
                ...
                Expanded(
                  child: FormSearch(
                    ...
                    onChange: (String text) async {
                      ...
                      Get.find<MainBodController>().refreshList();
                    },
        ...
        FutureBuilder<List<DetailBUMNTalent>>(
          future: ListApiHC().getDataListTalenta("bod?$pathEndPoint"),
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              if (hasil.length == 0) {
                ...
                return GetBuilder<MainBodController>(
                  id: 'refreshList',
                  init: MainBodController(),
                  builder: (controller) {
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                ApiStatistic().insertStatistic("Human Capital",
                                    "Detail Talenta BOD ${listDataChanges[index].nama_lengkap.toString()} BOD");
