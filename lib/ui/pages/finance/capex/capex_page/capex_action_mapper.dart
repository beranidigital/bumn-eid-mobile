...
class CapexActionMapper extends ActionMapper {
  CapexActionMapper(Store<AppState> store) : super(store);
  ...
  openDetailedCapexPage(String tahun) => dispatch(NavigateToNextAction(
      destination: CapexDetailedPageDestination(tahun: tahun)));
}
