...
import 'package:bumn_eid/ui/pages/hc/dekom/dekom_by_anak_company_page/di/dekom_by_anak_company_page_graph.dart';
import 'package:bumn_eid/ui/utils/color_palette.dart';
import 'package:flutter/material.dart';
import 'package:flutter_redux/flutter_redux.dart';

// ignore: must_be_immutable
class DekomByAnakCompanyPage extends StatefulWidget with InjectableWidget {
  final DekomByAnakCompanyPageGraph _graph;
  ...
  //injected
  DekomByAnakCompanyActionMapper actionMapper;
  //injected
  HcController hcController;

  @override
  DekomByAnakCompanyPageGraph graph() => _graph;

  DekomByAnakCompanyPage(
      {@required this.company, DekomByAnakCompanyPageGraph graph})
      : this._graph = graph ?? DekomByAnakCompanyPageGraph() {
    setup();
  }

  @override
  _DekomByAnakCompanyPageState createState() => _DekomByAnakCompanyPageState();
}

class _DekomByAnakCompanyPageState extends State<DekomByAnakCompanyPage>
    with AfterLayoutMixin<DekomByAnakCompanyPage> {
  ...
  void getData() async {
    try {
      ...
      final data = await widget.hcController
          .fetchPejabatByAnakCompany(anakName: widget.company.anak);
