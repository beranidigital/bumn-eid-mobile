...
import 'package:bumn_eid/ui/pages/hc/dekom/company_dekom_page/di/company_dekom_page_graph.dart';
...
class CompanyDekomPage extends StatefulWidget with InjectableWidget {
  final CompanyDekomPageGraph _graph;
  ...
  //injected
  CompanyDekomActionMapper actionMapper;

  CompanyDekomPage({@required this.id, CompanyDekomPageGraph graph})
      : this._graph = graph ?? CompanyDekomPageGraph() {
    setup();
  }

  @override
  CompanyDekomPageGraph graph() => _graph;

  @override
  _CompanyDekomPageState createState() => _CompanyDekomPageState();
}

class _CompanyDekomPageState extends State<CompanyDekomPage>
    with AfterLayoutMixin<CompanyDekomPage> {
  bool isError = false;
