...
import 'package:bumn_eid/ui/pages/hc/dekom/dekom_by_cucu_company_page/di/dekom_by_cucu_company_page_graph.dart';
import 'package:bumn_eid/ui/utils/color_palette.dart';
import 'package:flutter/material.dart';
import 'package:flutter_redux/flutter_redux.dart';

// ignore: must_be_immutable
class DekomByCucuCompanyPage extends StatefulWidget with InjectableWidget {
  final DekomByCucuCompanyPageGraph _graph;
  ...
  //injected
  DekomByCucuCompanyActionMapper actionMapper;
  //injected
  HcController hcController;

  @override
  DekomByCucuCompanyPageGraph graph() => _graph;

  DekomByCucuCompanyPage(
      {@required this.company, DekomByCucuCompanyPageGraph graph})
      : this._graph = graph ?? DekomByCucuCompanyPageGraph() {
    setup();
  }

  @override
  _DekomByCucuCompanyPageState createState() => _DekomByCucuCompanyPageState();
}

class _DekomByCucuCompanyPageState extends State<DekomByCucuCompanyPage>
    with AfterLayoutMixin<DekomByCucuCompanyPage> {
