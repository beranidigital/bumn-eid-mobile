...
import 'package:bumn_eid/ui/pages/hc/bod/bod_by_company_page/di/bod_by_company_page_graph.dart';
import 'package:bumn_eid/ui/utils/color_palette.dart';
import 'package:flutter/material.dart';
import 'package:flutter_redux/flutter_redux.dart';

// ignore: must_be_immutable
class BODByCompanyPage extends StatefulWidget with InjectableWidget {
  final BODByCompanyPageGraph _graph;
  ...
  //injected
  BODByCompanyActionMapper actionMapper;
  //injected
  HcController hcController;

  @override
  BODByCompanyPageGraph graph() => _graph;

  BODByCompanyPage({@required this.company, BODByCompanyPageGraph graph})
      : this._graph = graph ?? BODByCompanyPageGraph() {
    setup();
  }

  @override
  _BODByCompanyPageState createState() => _BODByCompanyPageState();
}

class _BODByCompanyPageState extends State<BODByCompanyPage>
    with AfterLayoutMixin<BODByCompanyPage> {
  ...
  void getData() async {
    try {
      ...
      final data = await widget.hcController
          .fetchBODByCompany(companyId: widget.company.getId());
