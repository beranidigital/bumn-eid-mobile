...
import 'package:bumn_eid/ui/pages/hc/bod/bod_cucu_company_page/di/bod_cucu_company_page_graph.dart';
...
class BODCucuCompanyPage extends StatefulWidget with InjectableWidget {
  final BODCucuCompanyPageGraph _graph;
  ...
  //injected
  BODCucuCompanyActionMapper actionMapper;
  //injected
  HcController hcController;

  @override
  BODCucuCompanyPageGraph graph() => _graph;

  BODCucuCompanyPage({@required this.company, BODCucuCompanyPageGraph graph})
      : this._graph = graph ?? BODCucuCompanyPageGraph() {
    setup();
  }

  @override
  _BODCucuCompanyPageState createState() => _BODCucuCompanyPageState();
}

class _BODCucuCompanyPageState extends State<BODCucuCompanyPage>
    with AfterLayoutMixin<BODCucuCompanyPage> {
              ...
              return TableRow(children: [
                ...
                cell(
                    ...
                    onTap: () => widget.actionMapper
                        .openBODByCucuCompanyPage(company: value))
              ]);
            },
          );
  }
