...
import 'package:bumn_eid/ui/pages/hc/bod/bod_by_anak_company_page/di/bod_by_anak_company_page_graph.dart';
import 'package:bumn_eid/ui/utils/color_palette.dart';
import 'package:flutter/material.dart';
import 'package:flutter_redux/flutter_redux.dart';

// ignore: must_be_immutable
class BODByAnakCompanyPage extends StatefulWidget with InjectableWidget {
  final BODByAnakCompanyPageGraph _graph;
  ...
  //injected
  BODByAnakCompanyActionMapper actionMapper;
  //injected
  HcController hcController;

  @override
  BODByAnakCompanyPageGraph graph() => _graph;

  BODByAnakCompanyPage(
      {@required this.company, BODByAnakCompanyPageGraph graph})
      : this._graph = graph ?? BODByAnakCompanyPageGraph() {
    setup();
  }

  @override
  _BODByAnakCompanyPageState createState() => _BODByAnakCompanyPageState();
}

class _BODByAnakCompanyPageState extends State<BODByAnakCompanyPage>
    with AfterLayoutMixin<BODByAnakCompanyPage> {
