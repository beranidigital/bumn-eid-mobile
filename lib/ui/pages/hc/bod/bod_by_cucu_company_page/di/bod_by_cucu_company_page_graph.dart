...
class BODByCucuCompanyPageGraph extends Graph<BODByCucuCompanyPage> {

  BODByCucuCompanyPageGraph([Injector injector]) : super(injector);

  // Inside this method, we inject the BODByCucuCompanyPage dependencies from injector to the instance
  @override
  void inject(BODByCucuCompanyPage subject) {
    // For example: subject.store = getDependency<Store<AppState>>();
    subject.colorPalette = getDependency<ColorPalette>();
    subject.actionMapper = getDependency<BODByCucuCompanyActionMapper>();
    subject.hcController = getDependency<HcController>();
  }

  // Inside this method, we register all the BODByCucuCompanyPage dependencies:
  @override
  void register() {
    registerDependency<BODByCucuCompanyActionMapper>((injector) {
      final store = injector.getDependency<Store<AppState>>();
      return BODByCucuCompanyActionMapper(store);
    });
  }
}
