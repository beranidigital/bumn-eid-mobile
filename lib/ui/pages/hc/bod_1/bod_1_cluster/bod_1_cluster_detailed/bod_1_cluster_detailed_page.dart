...
import 'package:bumn_eid/ui/pages/hc/bod_1/bod_1_cluster/bod_1_cluster_detailed/di/bod_1_cluster_detailed_page_graph.dart';
...
class BOD1ClusterDetailedPage extends StatefulWidget with InjectableWidget {
  final BOD1ClusterDetailedPageGraph _graph;
  final String cluster;

  //injected
  ColorPalette colorPalette;
  //injected
  BOD1ClusterDetailedActionMapper actionMapper;
  //injected
  ...
  @override
  BOD1ClusterDetailedPageGraph graph() => _graph;

  BOD1ClusterDetailedPage(this.cluster, [graph])
      : this._graph = graph ?? BOD1ClusterDetailedPageGraph() {
    setup();
  }

  @override
  _BOD1ClusterDetailedPageState createState() =>
      _BOD1ClusterDetailedPageState();
}

class _BOD1ClusterDetailedPageState extends State<BOD1ClusterDetailedPage>
    with AfterLayoutMixin<BOD1ClusterDetailedPage> {
  ...
  void getData() async {
    try {
      ...
      List<BOD1Company> companies = await widget.hcController
          .fetchBOD1CompaniesByCluster(cluster: widget.cluster);
      HcSummary summary = await widget.hcController
          .fetchHcSummary(filter: "cluster", query: widget.cluster);
  ...
  void filterClusterDetailed(String query) {
  ...
  Widget searchBar(BuildContext context) {
    return Padding(
      ...
      child: TextField(
        ...
        onChanged: (query) => filterClusterDetailed(query),
