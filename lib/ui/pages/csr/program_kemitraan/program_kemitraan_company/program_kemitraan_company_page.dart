...
import 'package:bumn_eid/ui/pages/csr/program_kemitraan/program_kemitraan_company/di/program_kemitraan_company_page_graph.dart';
...
class PKCompanyPage extends StatefulWidget with InjectableWidget {
  final PKCompanyPageGraph _graph;

  //injected
  ColorPalette colorPalette;
  //injected
  PKCompanyActionMapper actionMapper;
  //injected
  ...
  @override
  PKCompanyPageGraph graph() => _graph;

  PKCompanyPage([graph]) : this._graph = graph ?? PKCompanyPageGraph() {
    setup();
  }

  @override
  _PKCompanyPageState createState() => _PKCompanyPageState();
}

class _PKCompanyPageState extends State<PKCompanyPage>
    with AfterLayoutMixin<PKCompanyPage> {
        ...
        cell(
          ...
          onTap: () {
            ApiStatistic().insertStatistic(
                "CSR", "Level 4 ${data.id} PK By Company Program Kemitraan");
